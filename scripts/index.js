...
const nameInput = popupProfile.querySelector('#popup__input_name'); // поле ввода имени,
const jobInput = popupProfile.querySelector('#popup__input_job'); // поле ввода проффессии,
