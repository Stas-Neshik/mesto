class FormValidator {
    ...
    // если убрать this. из 11 строки валидация ломается полностью, из 14 и 15 убрал
    enableValidation() {
        ...
        this.formEl.addEventListener('submit', (evt) => {
            ...
            Array.from(formInputEls).every(input => this._checkInputValidity(input)) && this._toggleOnSubmitBtn(formSubmitBtnEl, inactiveButtonClass);
